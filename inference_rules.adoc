...
The current power measurement recommendations for single-node wall-powered and battery-powered systems is available at https://docs.google.com/document/d/1fnhjauZE_eQk5sLT5h6BumyWtyh-S-Lk4pRlkVU0hH4/edit# and will be migrated into GitHub once it is suitably stable.
