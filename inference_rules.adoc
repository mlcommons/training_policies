...
resources that will be measured for perforamnce.  The hardware resources may
...
system or framework, you must use publicly available and widely-used used
versions of the system or framework.
...
The MLPerf provided load generator (LoadGen) controls and initates inference
...
* Caching of any queries, any query params, or any intermediate results is
  prohibited.
