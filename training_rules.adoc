...
|Language |Small LLM Pretraining |Llama3.1-8b |TBD |v5.1
| |LLM pretraining |Llama31-405B |5.6 log perplexity |v5.1
| |LLM finetuning |Llama2-70B-LoRA |0.925 Eval loss |v5.1
|Commerce |Recommendation |DLRMv2 (DCNv2) |0.80275 AUC |v5.1
|Graphs | Node classification|R-GAT | 72.0 % classification |v5.1
|===
...
|       |Text to image |Flux.1 | TBD |v5.1
|Language|Small LLM pretraining |Llama3.1_8b| TBD |v5.1
...
|Graphs|Node classification|R-GAT|Evaluate 20 times per epoch |v5.1
|===
...
| Llmama3.1_8b | Training sample (integer) | v5.1
...
| R-GAT | Training iteration as the fraction of a total number of iterations for one epoch (0.05, 0.1, 0.15, ..., 1.0) | v5.1
|===
