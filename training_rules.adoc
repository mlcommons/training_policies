...
|===
 ...
 |deepseekv3_671b |adamw |opt_end_learning_rate |opt_base_learning_rate * 0.1 |learning rate at the last step of decay period |TODO |v6.0
 |deepseekv3_671b |adamw |dropout |0.0 |Disable all dropouts during training. |TODO |v6.0
