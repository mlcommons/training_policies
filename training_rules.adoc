...
|       |Text to image |Flux.1 | TBD |v5.1
|Language|Small LLM pretraining |Llama31_8b| TBD |v5.1
|        |LLM pretraining |Llama31_405B| Every 18432 sequences; CEIL(18432 / global_batch_size) steps if 18432 is not divisible by GBS. Skipping first `18432*CEILING(0.0026*global_batch_size+10)` evaluations |v5.1
