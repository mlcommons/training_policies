...
* Node Classification
** Timed region: Graph loading, training, evaluation are all timed. Graph-partitioning for multi-node runs is not timed.
...
** Sampler: We do not impose that submitters using standard frameworks to maintain exact sampler equivalence as reference, but must meet RCP criteria
