...
| |Text to image |Stable Diffusion v2.0 |80 FID and 0.339 CLIP
...
|       |Text to image |Stable Diffusion v2.0 |Every 2,048,000 images. CEIL(2048000 / global_batch_size) if 2048000 is not divisible by GBS
