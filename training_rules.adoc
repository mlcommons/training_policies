...
|Language | GPT-OSS-20B pretraining |c4/en/3.0.1 |v6.0
...
|Language | GPT-OSS-20B pretraining | GPT_OSS_20B | 3.34 log perplexity |v6.0
...
|Language | GPT-OSS-20B pretraining | GPT_OSS_20B| Every 12288 sequences; `CEIL(12288 / global_batch_size) * global_batch_size` steps if 12288 is not divisible by GBS. |v6.0
...
|Language | GPT-OSS-20B pretraining | 10 | v6.0
