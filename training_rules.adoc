...
|link:https://github.com/mlperf/training/blob/00570abf77d351e474d57830014f6a3e501dece1/image_classification/tensorflow/official/utils/arg_parsers/parsers.py#L158[reference code]
 ...
 |rnnt |lamb |global_batch_size                       |unconstrained |reference --batch_size       |
 |rnnt |lamb |opt_name                                |"lamb"        |The optimizer that was used. |
 |rnnt |lamb |opt_base_learning_rate                  |unconstrained |TODO |
 |rnnt |lamb |opt_lamb_epsilon                        |1e-9          |TODO |
 |rnnt |lamb |opt_lamb_learning_rate_poly_decay_power |unconstrained |TODO |
 |rnnt |lamb |opt_lamb_learning_rate_hold_epochs      |unconstrained |TODO |
 |rnnt |lamb |opt_learning_rate_warmup_epochs         |unconstrained |TODO |
 |rnnt |lamb |opt_weight_decay                        |1e-3          |TODO |
 |rnnt |lamb |opt_lamb_beta_1                         |unconstrained |TODO |
 |rnnt |lamb |opt_lamb_beta_2                         |unconstrained |TODO |
 |rnnt |lamb |opt_gradient_clip_norm                  |None          |TODO |
 |rnnt |lamb |opt_gradient_accumulation_steps         |unconstrained |TODO |
 |rnnt |lamb |opt_learning_rate_alt_decay_func        |True          |TODO |
 |rnnt |lamb |opt_learning_rate_alt_warmup_func       |True          |TODO |
 |rnnt |lamb |opt_lamb_learning_rate_min              |1e-5          |TODO |
 |rnnt |lamb |train_samples                           |unconstrained |TODO |
 |rnnt |lamb |eval_samples                            |2703          |TODO |
 |rnnt |lamb |data_train_max_duration                 |unconstrained |TODO |
 |rnnt |lamb |data_train_num_buckets                  |6             |TODO |
 |rnnt |lamb |data_train_speed_perturbation_min       |0.85          |TODO |
 |rnnt |lamb |data_train_speed_perturbation_max       |1.15          |TODO |
 |rnnt |lamb |data_spec_augment_freq_n                |2             |TODO |
 |rnnt |lamb |data_spec_augment_freq_max              |0             |TODO |
 |rnnt |lamb |data_spec_augment_freq_min              |20            |TODO |
 |rnnt |lamb |data_spec_augment_time_n                |10            |TODO |
 |rnnt |lamb |data_spec_augment_time_min              |0             |TODO |
 |rnnt |lamb |data_spec_augment_time_max              |0.03          |TODO |
 |rnnt |lamb |model_eval_ema_factor                   |unconstrained |TODO |
