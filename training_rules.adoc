...
| |LLM MoE Pretraining |DeepSeek_V3 |3.6 log perplexity |v6.0
...
|===
 ...
 |deepseek_v3 |adamw |global_batch_size |unconstrained |batch size in sequences |TODO |v6.0
 |deepseek_v3 |adamw |opt_adamw_beta_1 |0.9 |AdamW beta1 |TODO |v6.0
 |deepseek_v3 |adamw |opt_adamw_beta_2 |0.95 |AdamW beta2 |TODO |v6.0
 |deepseek_v3 |adamw |opt_adamw_epsilon |1e-5 |AdamW epsilon |TODO |v6.0
 |deepseek_v3 |adamw |opt_gradient_clip_norm |1.0 |Gradients are clipped above this norm threshold. |TODO |v6.0
 |deepseek_v3 |adamw |opt_adamw_weight_decay |0.1 |weight decay |TODO |v6.0
 |deepseek_v3 |adamw |opt_learning_rate_warmup_steps |unconstrained |steps taken for linear warmup. |TODO |v6.0
 |deepseek_v3 |adamw |opt_learning_rate_decay_steps |1_200_000 - opt_learning_rate_warmup_steps |Step when the end of cosine learning rate curve is reached. Learning rate cosine decay is in range (opt_learning_rate_warmup_steps + 1,opt_learning_rate_decay_steps]. |TODO |v6.0
 |deepseek_v3 |adamw |opt_base_learning_rate |unconstrained |base learning rate |TODO |v6.0
 |deepseek_v3 |adamw |opt_end_learning_rate |opt_base_learning_rate * 0.1 |learning rate at the last step of decay period |TODO |v6.0
 |deepseek_v3 |adamw |dropout |0.0 |Disable all dropouts during training. |TODO |v6.0
 |deepseek_v3 |adamw |sequence_length |4096 |sequence length |TODO |v6.0
 |deepseek_v3 |adamw |gradient_accumulation_steps |unconstrained |Number of fwd/bwd steps between optimizer step. |TODO |v6.0
 |deepseek_v3 |adamw |max_steps |1200000 |maximum number of steps |TODO |v6.0
|===
...
|        |LLM MoE Pretraining |DeepSeek_V3| Every 12000 sequences; `CEIL(12000 / global_batch_size) * global_batch_size` steps if 12000 is not divisible by GBS. |v6.0
...
| DeepSeek_V3 | Training samples starting from 0 (integer) | v6.0
|===
