...
|===
 ...
 |deepseekv3_671b |adamw |opt_learning_rate_warmup_steps |constrained based on global_batch_size |steps taken for linear warmup. |TODO |v6.0
 ...
 |deepseekv3_671b |adamw |opt_base_learning_rate |constrained based on global_batch_size |refer to next table in section "DeepSeek-V3-671B learning rates" |TODO |v6.0
