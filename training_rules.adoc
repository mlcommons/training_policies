...
|===
 ...
 |deepseekv3_671b |adamw |opt_learning_rate_warmup_steps |unconstrained |steps taken for linear warmup. |TODO |v6.0
 ...
 |deepseekv3_671b |adamw |opt_base_learning_rate |unconstrained |base learning rate |TODO |v6.0
